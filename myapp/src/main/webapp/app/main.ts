...
import ChoosePizzaProcessService from '@/entities/choose-pizza-process/choose-pizza-process.service';
...
new Vue({
  ...
  provide: {
    ...
    choosePizzaService: () => new ChoosePizzaService(),
    choosePizzaProcessService: () => new ChoosePizzaProcessService(),
