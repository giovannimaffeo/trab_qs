<template>
  <div class="home row">
    <div class="col-md-9">
      <h1 class="display-4" v-text="$t('myapp3App.home.title')">Welcome, Java Hipster!</h1>
      <div>
      ...
      <p v-text="$t('myapp3App.home.question')">If you have any question on JHipster:</p>

      <ul>
        <li>
          <a href="https://www.jhipster.tech/" target="_blank" rel="noopener noreferrer" v-text="$t('myapp3App.home.link.homepage')"
            >JHipster homepage</a
          >
        </li>
        <li>
          <a
            ...
            v-text="$t('myapp3App.home.link.stackoverflow')"
        ...
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('myapp3App.home.link.bugtracker')"
            >JHipster bug tracker</a
          >
        </li>
        <li>
          <a href="https://twitter.com/agilekip" target="_blank" rel="noopener noreferrer" v-text="$t('myapp3App.home.link.follow')"
      ...
      <p>
        <span v-text="$t('myapp3App.home.like')">If you like AgileKip Generator, don't forget to give us a star on</span>
        <a
          href="https://github.com/agilekip/generator-jhipster-agilekip"
          target="_blank"
          rel="noopener noreferrer"
          v-text="$t('myapp3App.home.github')"
          >GitHub</a
        >!
      </p>
    </div>
