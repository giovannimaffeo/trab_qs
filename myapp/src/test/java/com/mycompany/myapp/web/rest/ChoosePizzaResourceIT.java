...
class ChoosePizzaResourceIT {
    ...
    private static final String DEFAULT_PIZZA_TYPE_1 = "AAAAAAAAAA";
    private static final String UPDATED_PIZZA_TYPE_1 = "BBBBBBBBBB";

    private static final String DEFAULT_PIZZA_TYPE_2 = "AAAAAAAAAA";
    private static final String UPDATED_PIZZA_TYPE_2 = "BBBBBBBBBB";
    ...
    public static ChoosePizza createEntity(EntityManager em) {
        ChoosePizza choosePizza = new ChoosePizza()
            .pizzaType1(DEFAULT_PIZZA_TYPE_1)
            .pizzaType2(DEFAULT_PIZZA_TYPE_2)
    ...
    public static ChoosePizza createUpdatedEntity(EntityManager em) {
        ChoosePizza choosePizza = new ChoosePizza()
            .pizzaType1(UPDATED_PIZZA_TYPE_1)
            .pizzaType2(UPDATED_PIZZA_TYPE_2)
    ...
    void getAllChoosePizzas() throws Exception {
        ...
        restChoosePizzaMockMvc
            ...
            .andExpect(jsonPath("$.[*].pizzaType1").value(hasItem(DEFAULT_PIZZA_TYPE_1)))
            .andExpect(jsonPath("$.[*].pizzaType2").value(hasItem(DEFAULT_PIZZA_TYPE_2)))
    ...
    void getChoosePizza() throws Exception {
        ...
        restChoosePizzaMockMvc
            ...
            .andExpect(jsonPath("$.pizzaType1").value(DEFAULT_PIZZA_TYPE_1))
            .andExpect(jsonPath("$.pizzaType2").value(DEFAULT_PIZZA_TYPE_2))
